      ...
      {resultado && (
        <div className="bg-white rounded-xl border-2 border-emerald-300 p-4 space-y-3">
          ...
          <div className="flex items-center gap-2 pt-1">
            ...
            {proyectoId && <a href={`/presentacion-fv/${proyectoId}`} target="_blank" rel="noreferrer" title="Presentación comercial para el cliente: propuesta agrupada SIN precios unitarios (solo el total del presupuesto). Imprimir/Guardar PDF." className="px-4 py-2 rounded-lg border border-amber-500 text-amber-600 text-sm font-semibold">🎨 Presentación</a>}
