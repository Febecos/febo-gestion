...
const POS = {
  numero: { top: 9.9, left: 59.2, w: 40, size: 18, bold: true, serif: true },
  ...
  valorDeclarado: { top: 87.2, left: 58, w: 38, size: 12, bold: true }, // pie del remito: la "V" arranca en la ZONA BLANCA a la DERECHA del código de barras (barcode termina ~53%; se deja gap), no lo pisa — Guille 15/07
};
  ...
  return (
    <div className="rwrap">
      ...
      <div className="rsheet">
        ...
        <div style={{ position: "absolute", top: "9.7%", left: "55%", width: "35%", height: "3.1%", background: "#fff" }} />
