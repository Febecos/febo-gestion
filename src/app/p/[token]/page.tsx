...
const POS = {
  ...
  valorDeclarado: { top: 87.2, left: 53, w: 43, size: 12, bold: true }, // pie del remito, la "V" arranca ~3mm a la DERECHA de donde termina el código de barras (barcode ~51.5% + 3mm) — Guille 14/07
};
